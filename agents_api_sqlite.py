...
# ----------------------------
# DB Setup (SQLite for easy testing)
# ----------------------------
DATABASE_URL = "sqlite:///./agrisathi.db"
...
def get_statistics(db: Session = Depends(get_db)):
    ...
    return {
        ...
        "tools": {
            "total": tool_count,
            "enabled": db.query(Tool).filter(Tool.is_enabled == True).count()
        },
        "tasks": {
            "total": task_count,
...
if __name__ == "__main__":
    ...
    print("Database: SQLite (agrisathi.db)")
